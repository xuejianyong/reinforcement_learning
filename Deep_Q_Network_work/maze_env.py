...
class Maze(tk.Tk, object):
    def __init__(self):
        ...
        self.n_features = 2  # 这个feature 是用来做什么用的呢？ A：其实就是状态的两个坐标
        self.title('maze')
    ...
    def step(self, action):
        ...
        self.canvas.move(self.rect, base_action[0], base_action[1])  # move agent 根据动作的执行情况，将agent放置于相应的位置
