...
class DQN:
    def __init__(self, params):
        ...
        print('---------------------------- parameter width, height ----------------------------')
        print('width: %d, height: %d' % (params['width'], params['height']))

        self.x = tf.placeholder('float', [None, params['width'], params['height'], 6], name=self.network_name + '_x')
        self.q_t = tf.placeholder('float', [None], name=self.network_name + '_q_t')  # if the shape is not specified, you can feed a tensor of any shppe
